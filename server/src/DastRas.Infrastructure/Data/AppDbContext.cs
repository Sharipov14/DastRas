...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>(e =>
        {
            ...
            e.HasData(
                new Product { Id = 1, CategoryId = 1, NameRu = "Помидоры", NameTj = "Помидор", NameEn = "Tomatoes", Price = 15, Unit = "кг", Rating = 4.8, ImageUrl = "https://picsum.photos/300/300?random=1", Description = "Свежие, сочные помидоры." },
                new Product { Id = 2, CategoryId = 1, NameRu = "Огурцы", NameTj = "Бодиринг", NameEn = "Cucumbers", Price = 12, Unit = "кг", Rating = 4.5, ImageUrl = "https://picsum.photos/300/300?random=2", Description = "Хрустящие огурцы." },
                new Product { Id = 3, CategoryId = 2, NameRu = "Яблоки", NameTj = "Себ", NameEn = "Apples", Price = 10, Unit = "кг", Rating = 4.9, ImageUrl = "https://picsum.photos/300/300?random=3", Description = "Сладкие красные яблоки." },
                new Product { Id = 4, CategoryId = 2, NameRu = "Бананы", NameTj = "Банан", NameEn = "Bananas", Price = 18, Unit = "кг", Rating = 4.7, ImageUrl = "https://picsum.photos/300/300?random=4", Description = "Спелые бананы." },
                new Product { Id = 5, CategoryId = 3, NameRu = "Молоко", NameTj = "Шир", NameEn = "Milk", Price = 8, Unit = "л", Rating = 4.6, ImageUrl = "https://picsum.photos/300/300?random=5", Description = "Натуральное молоко 3.2%." },
                new Product { Id = 6, CategoryId = 3, NameRu = "Сыр", NameTj = "Паннир", NameEn = "Cheese", Price = 45, Unit = "кг", Rating = 4.8, ImageUrl = "https://picsum.photos/300/300?random=6", Description = "Твердый сыр." },
                new Product { Id = 7, CategoryId = 4, NameRu = "Говядина", NameTj = "Гушти гов", NameEn = "Beef", Price = 85, Unit = "кг", Rating = 5.0, ImageUrl = "https://picsum.photos/300/300?random=7", Description = "Свежая говядина без костей." },
                new Product { Id = 8, CategoryId = 5, NameRu = "Хлеб", NameTj = "Нон", NameEn = "Bread", Price = 4, Unit = "шт", Rating = 4.9, ImageUrl = "https://picsum.photos/300/300?random=8", Description = "Горячий тандырный хлеб." }
            );
        });
